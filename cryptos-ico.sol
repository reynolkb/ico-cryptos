...
contract CryptosICO is Cryptos {
    ...
    uint public tokenTradeStart = saleEnd + 604800; // transferable in one week after sale
    ...
    // automatically called when someone sends ether directly to the contract's address
    ...
    function transfer(address to, uint tokens) public override returns(bool success) {
        ...
        // super.transfer(to, tokens); // is the same
